...
var KeyToOperateWith = '';

function changeKeyToOperateWith(key){
	KeyToOperateWith = key;
}
...
export {createTransaction, getPublicFromWallet,
    ...
    createTransactionVictoryPoints, getBalanceVictoryPoints,findUnspentTxOutsVictoryPoints, changeKeyToOperateWith, resetKey};
