...
router.post('/mine', userController.mine);
router.post('/getBalance', userController.getBalance);
router.post('/getBalanceVictory', userController.getBalanceVictory);
router.post('/mineTransaction', userController.mineTransaction);
router.post('/blocks', userController.blocks);
